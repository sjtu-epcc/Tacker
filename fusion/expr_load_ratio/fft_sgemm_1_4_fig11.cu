...
int main(int argc, char* argv[]) {
  ...
  // ---------------------------------------------------------------------------------------
    ...
    printf("fft gptb time: %f , sgemm gptb time: %f\n", gptb_fft_time, gptb_sgemm_time);
    printf("fft_blk_num: %d/%d, sgemm_blk_num: %d/%d\n", mix_fft_task_blk_num, 10240, mix_sgemm_task_blk_num, 774);
}
