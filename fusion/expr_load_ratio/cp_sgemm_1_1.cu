...
int main(int argc, char* argv[]) {
    ...
    float load_ratio = 1.06;
    int scaling_rate = 20;
    int ori_cp_task_blk_num = ori_cp_grid.x * ori_cp_grid.y * ori_cp_grid.z;
    int ori_sgemm_task_blk_num = ori_sgemm_grid.x * ori_sgemm_grid.y * ori_sgemm_grid.z;
    int mix_sgemm_task_blk_num = 408;
    int mix_cp_task_blk_num = min(int(mix_sgemm_task_blk_num * load_ratio * scaling_rate), ori_cp_task_blk_num);
  ...
  // ---------------------------------------------------------------------------------------
    ...
    printf("cp gptb time: %f , sgemm gptb time: %f\n", gptb_cp_time, gptb_sgemm_time);
    printf("cp_blk_num: %d/%d, sgemm_blk_num: %d/%d\n", mix_cp_task_blk_num, ori_cp_task_blk_num, mix_sgemm_task_blk_num, ori_sgemm_task_blk_num);
