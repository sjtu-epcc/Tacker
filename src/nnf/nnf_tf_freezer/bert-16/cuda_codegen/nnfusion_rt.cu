...
#define NNFUSION_GRAPH_INPUT_SHAPE_0 {16, 128}
#define NNFUSION_GRAPH_INPUT_DTYPE_1 int32_t
#define NNFUSION_GRAPH_INPUT_SHAPE_1 {16, 128}
#define NNFUSION_GRAPH_INPUT_DTYPE_2 int32_t
#define NNFUSION_GRAPH_INPUT_SHAPE_2 {16, 128}
#define NNFUSION_GRAPH_OUTPUT_DTYPE_0 float
#define NNFUSION_GRAPH_OUTPUT_SHAPE_0 {16, 1001}
#endif

// Node name:	Dot_390
// Description:	Dot
// Input:
//	- name: Tanh_389_0	type: float	shape: Shape{16, 1024}
//	- name: Constant_111_0	type: float	shape: Shape{1024, 1001}
// Output:
//	- name: Dot_390_0	type: float	shape: Shape{16, 1001}
void Dot_float_float_float_cuda_lib_Dot_390(cublasHandle_t cublas_handle, float* input0, float* input1, float* output0)
{
    const float alpha = 1.0;
    const float beta = 0;
    CUBLAS_SAFE_CALL(cublasSgemm(cublas_handle, CUBLAS_OP_N, CUBLAS_OP_N, 1001, 16, 1024, &alpha, static_cast<const float*>(input1), 1001, static_cast<const float*>(input0), 1024, &beta, static_cast<float*>(output0), 1001));
...
//	- name: Dot_179_0	type: float	shape: Shape{2048, 1024}
// Output:
//	- name: Add_185_0	type: float	shape: Shape{2048, 1024}
// Fused functions:
// Broadcast_float_float_cuda_Broadcast_184<<<dim3(32768, 1, 1), dim3(64, 1, 1), 0, 0>>>(Constant_32_0, Broadcast_184_0);
// Add_float_float_float_cuda_Add_185<<<dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0>>>(Dot_179_0, Broadcast_184_0, Add_185_0);
...
// Description:	Sum
// Input:
//	- name: Add_142_0	type: float	shape: Shape{16, 128, 1024}
// Output:
//	- name: Sum_149_0	type: float	shape: Shape{16, 128}
...
// Input:
//	- name: Reshape_126_0	type: float	shape: Shape{16, 128}
// Output:
//	- name: Broadcast_127_0	type: float	shape: Shape{16, 128, 128}
extern "C" __launch_bounds__(64) __global__ void Broadcast_float_float_cuda_Broadcast_127(float* input0, float* output0)
{
    size_t nthreads = 262144;uint32_t strides0 = 16384;
...
// Description:	Broadcast
// Input:
//	- name: Reshape_195_0	type: float	shape: Shape{16, 128, 128}
// Output:
//	- name: Broadcast_196_0	type: float	shape: Shape{16, 16, 128, 128}
extern "C" __launch_bounds__(64) __global__ void Broadcast_float_float_cuda_Broadcast_196(float* input0, float* output0)
{
    size_t nthreads = 4194304;uint32_t strides0 = 262144;
...
// Input:
// Output:
//	- name: Constant_357_0	type: float	shape: Shape{2048}
...
// Input:
// Output:
//	- name: Constant_158_0	type: float	shape: Shape{16, 128}
...
// Input:
// Output:
//	- name: Constant_318_0	type: float	shape: Shape{2048}
...
// Input:
// Output:
//	- name: Constant_150_0	type: float	shape: Shape{16, 128}
...
// Input:
// Output:
//	- name: Constant_215_0	type: float	shape: Shape{2048}
...
//	- name: Reshape_153_0	type: float	shape: Shape{16, 128}
//	- name: Reshape_165_0	type: float	shape: Shape{16, 128}
//	- name: Constant_19_0	type: float	shape: Shape{1024}
//	- name: Add_142_0	type: float	shape: Shape{16, 128, 1024}
// Output:
//	- name: Add_175_0	type: float	shape: Shape{16, 128, 1024}
// Fused functions:
// Broadcast_float_float_cuda_Broadcast_173<<<dim3(32768, 1, 1), dim3(64, 1, 1), 0, 0>>>(Constant_18_0, Broadcast_173_0);
// Broadcast_float_float_cuda_Broadcast_154<<<dim3(32768, 1, 1), dim3(64, 1, 1), 0, 0>>>(Reshape_153_0, Broadcast_154_0);
// Broadcast_float_float_cuda_Broadcast_166<<<dim3(32768, 1, 1), dim3(64, 1, 1), 0, 0>>>(Reshape_165_0, Broadcast_166_0);
// Broadcast_float_float_cuda_Broadcast_167<<<dim3(32768, 1, 1), dim3(64, 1, 1), 0, 0>>>(Constant_19_0, Broadcast_167_0);
// Multiply_float_float_float_cuda_Multiply_168<<<dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0>>>(Broadcast_166_0, Broadcast_167_0, Multiply_168_0);
// Multiply_float_float_float_cuda_Multiply_172<<<dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0>>>(Broadcast_154_0, Multiply_168_0, Multiply_172_0);
// Subtract_float_float_float_cuda_Subtract_174<<<dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0>>>(Broadcast_173_0, Multiply_172_0, Subtract_174_0);
// Multiply_float_float_float_cuda_Multiply_169<<<dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0>>>(Add_142_0, Multiply_168_0, Multiply_169_0);
// Add_float_float_float_cuda_Add_175<<<dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0>>>(Multiply_169_0, Subtract_174_0, Add_175_0);
...
// Input:
// Output:
//	- name: Constant_207_0	type: float	shape: Shape{2048}
...
// Input:
// Output:
//	- name: Constant_262_0	type: float	shape: Shape{2048}
...
// Input:
// Output:
//	- name: Constant_254_0	type: float	shape: Shape{2048}
...
// Input:
//	- name: Constant_37_0	type: float	shape: Shape{}
//	- name: BatchMatMul_192_0	type: float	shape: Shape{16, 16, 128, 128}
//	- name: Broadcast_196_0	type: float	shape: Shape{16, 16, 128, 128}
// Output:
//	- name: Add_197_0	type: float	shape: Shape{16, 16, 128, 128}
// Fused functions:
// Broadcast_float_float_cuda_Broadcast_193<<<dim3(65536, 1, 1), dim3(64, 1, 1), 0, 0>>>(Constant_37_0, Broadcast_193_0);
// Multiply_float_float_float_cuda_Multiply_194<<<dim3(8192, 1, 1), dim3(512, 1, 1), 0, 0>>>(BatchMatMul_192_0, Broadcast_193_0, Multiply_194_0);
// Add_float_float_float_cuda_Add_197<<<dim3(8192, 1, 1), dim3(512, 1, 1), 0, 0>>>(Multiply_194_0, Broadcast_196_0, Add_197_0);
...
// Input:
// Output:
//	- name: Constant_310_0	type: float	shape: Shape{2048}
...
// Description:	OneHot
// Input:
//	- name: Reshape_114_0	type: int32_t	shape: Shape{2048}
// Output:
//	- name: OneHot_118_0	type: float	shape: Shape{2048, 2}
...
//	- name: Add_142_0	type: float	shape: Shape{16, 128, 1024}
// Output:
//	- name: Multiply_156_0	type: float	shape: Shape{16, 128, 1024}
// Fused functions:
// Broadcast_float_float_cuda_Broadcast_154<<<dim3(32768, 1, 1), dim3(64, 1, 1), 0, 0>>>(Reshape_153_0, Broadcast_154_0);
// Subtract_float_float_float_cuda_Subtract_155<<<dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0>>>(Add_142_0, Broadcast_154_0, Subtract_155_0);
// Multiply_float_float_float_cuda_Multiply_156<<<dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0>>>(Subtract_155_0, Subtract_155_0, Multiply_156_0);
...
// Description:	Softmax
// Input:
//	- name: Add_392_0	type: float	shape: Shape{16, 1001}
// Output:
//	- name: Softmax_393_0	type: float	shape: Shape{16, 1001}
void Softmax_float_float_cuda_lib_Softmax_393(cudnnHandle_t cudnn_handle, float* input0, float* output0)
{
    ...
    CUDNN_SAFE_CALL(cudnnSetTensor4dDescriptor(input_tensor_desc, CUDNN_TENSOR_NCHW, CUDNN_DATA_FLOAT, 16, 1, 1, 1001));
    cudnnTensorDescriptor_t output_tensor_desc;
    CUDNN_SAFE_CALL(cudnnCreateTensorDescriptor(&output_tensor_desc));
    CUDNN_SAFE_CALL(cudnnSetTensor4dDescriptor(output_tensor_desc, CUDNN_TENSOR_NCHW, CUDNN_DATA_FLOAT, 16, 1, 1, 1001));
    const float alpha = 1.0;
...
// Input:
//	- name: Reshape_189_0	type: float	shape: Shape{16, 16, 128, 64}
//	- name: Reshape_190_0	type: float	shape: Shape{16, 16, 128, 64}
// Output:
//	- name: BatchMatMul_192_0	type: float	shape: Shape{16, 16, 128, 128}
...
// Node name:	 Elementwise Kernel Fusion
// Input:
//	- name: GatherV2_121_0	type: float	shape: Shape{2048, 1024}
//	- name: Dot_122_0	type: float	shape: Shape{2048, 1024}
...
// Add_float_float_float_cuda_Add_133<<<dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0>>>(Reshape_129_0, Reshape_130_0, Add_133_0);
// Broadcast_float_float_cuda_Broadcast_141<<<dim3(32768, 1, 1), dim3(64, 1, 1), 0, 0>>>(Reshape_140_0, Broadcast_141_0);
// Add_float_float_float_cuda_Add_142<<<dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0>>>(Add_133_0, Broadcast_141_0, Add_142_0);
...
// Description:	Dot
// Input:
//	- name: Reshape_176_0	type: float	shape: Shape{2048, 1024}
...
void Dot_float_float_float_cuda_lib_Dot_179(cublasHandle_t cublas_handle, float* input0, float* input1, float* output0)
{
    const float alpha = 1.0;
    const float beta = 0;
    CUBLAS_SAFE_CALL(cublasSgemm(cublas_handle, CUBLAS_OP_N, CUBLAS_OP_N, 1024, 2048, 1024, &alpha, static_cast<const float*>(input1), 1024, static_cast<const float*>(input0), 1024, &beta, static_cast<float*>(output0), 1024));
...
//	- name: Softmax_393_0	type: float	shape: Shape{16, 1001}
// Output:
//	- name: Result_394_0	type: float	shape: Shape{16, 1001}
...
// Description:	Reshape
// Input:
//	- name: Reshape_188_0	type: float	shape: Shape{16, 128, 16, 64}
// Output:
//	- name: Reshape_191_0	type: float	shape: Shape{16, 16, 128, 64}
...
//	- name: Constant_150_0	type: float	shape: Shape{16, 128}
// Output:
//	- name: Divide_151_0	type: float	shape: Shape{16, 128}
...
// Input:
//	- name: Constant_4_0	type: float	shape: Shape{30522, 1024}
//	- name: Reshape_117_0	type: int32_t	shape: Shape{2048}
// Output:
//	- name: GatherV2_121_0	type: float	shape: Shape{2048, 1024}
...
//	- name: Constant_55_0	type: float	shape: Shape{}
//	- name: Constant_53_0	type: float	shape: Shape{4096}
//	- name: Dot_233_0	type: float	shape: Shape{2048, 4096}
//	- name: Constant_54_0	type: float	shape: Shape{}
// Output:
//	- name: Multiply_248_0	type: float	shape: Shape{2048, 4096}
// Fused functions:
// Broadcast_float_float_cuda_Broadcast_246<<<dim3(131072, 1, 1), dim3(64, 1, 1), 0, 0>>>(Constant_58_0, Broadcast_246_0);
// Broadcast_float_float_cuda_Broadcast_244<<<dim3(131072, 1, 1), dim3(64, 1, 1), 0, 0>>>(Constant_57_0, Broadcast_244_0);
// Broadcast_float_float_cuda_Broadcast_241<<<dim3(131072, 1, 1), dim3(64, 1, 1), 0, 0>>>(Constant_56_0, Broadcast_241_0);
// Broadcast_float_float_cuda_Broadcast_238<<<dim3(131072, 1, 1), dim3(64, 1, 1), 0, 0>>>(Constant_55_0, Broadcast_238_0);
// Broadcast_float_float_cuda_Broadcast_234<<<dim3(131072, 1, 1), dim3(64, 1, 1), 0, 0>>>(Constant_53_0, Broadcast_234_0);
// Add_float_float_float_cuda_Add_235<<<dim3(16384, 1, 1), dim3(512, 1, 1), 0, 0>>>(Dot_233_0, Broadcast_234_0, Add_235_0);
// Broadcast_float_float_cuda_Broadcast_236<<<dim3(131072, 1, 1), dim3(64, 1, 1), 0, 0>>>(Constant_54_0, Broadcast_236_0);
// Power_float_float_float_cuda_Power_237<<<dim3(16384, 1, 1), dim3(512, 1, 1), 0, 0>>>(Add_235_0, Broadcast_236_0, Power_237_0);
// Multiply_float_float_float_cuda_Multiply_239<<<dim3(16384, 1, 1), dim3(512, 1, 1), 0, 0>>>(Broadcast_238_0, Power_237_0, Multiply_239_0);
// Add_float_float_float_cuda_Add_240<<<dim3(16384, 1, 1), dim3(512, 1, 1), 0, 0>>>(Add_235_0, Multiply_239_0, Add_240_0);
// Multiply_float_float_float_cuda_Multiply_242<<<dim3(16384, 1, 1), dim3(512, 1, 1), 0, 0>>>(Broadcast_241_0, Add_240_0, Multiply_242_0);
// Tanh_float_float_cuda_Tanh_243<<<dim3(16384, 1, 1), dim3(512, 1, 1), 0, 0>>>(Multiply_242_0, Tanh_243_0);
// Add_float_float_float_cuda_Add_245<<<dim3(16384, 1, 1), dim3(512, 1, 1), 0, 0>>>(Broadcast_244_0, Tanh_243_0, Add_245_0);
// Multiply_float_float_float_cuda_Multiply_247<<<dim3(16384, 1, 1), dim3(512, 1, 1), 0, 0>>>(Broadcast_246_0, Add_245_0, Multiply_247_0);
// Multiply_float_float_float_cuda_Multiply_248<<<dim3(16384, 1, 1), dim3(512, 1, 1), 0, 0>>>(Add_235_0, Multiply_247_0, Multiply_248_0);
...
// Input:
//	- name: Constant_46_0	type: float	shape: Shape{1024}
//	- name: Dot_202_0	type: float	shape: Shape{2048, 1024}
//	- name: Reshape_176_0	type: float	shape: Shape{2048, 1024}
// Output:
//	- name: Add_205_0	type: float	shape: Shape{2048, 1024}
// Fused functions:
// Broadcast_float_float_cuda_Broadcast_203<<<dim3(32768, 1, 1), dim3(64, 1, 1), 0, 0>>>(Constant_46_0, Broadcast_203_0);
// Add_float_float_float_cuda_Add_204<<<dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0>>>(Dot_202_0, Broadcast_203_0, Add_204_0);
// Add_float_float_float_cuda_Add_205<<<dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0>>>(Add_204_0, Reshape_176_0, Add_205_0);
...
// Input:
//	- name: Constant_110_0	type: float	shape: Shape{1024}
//	- name: Dot_386_0	type: float	shape: Shape{16, 1024}
// Output:
//	- name: Tanh_389_0	type: float	shape: Shape{16, 1024}
// Fused functions:
// Broadcast_float_float_cuda_Broadcast_387<<<dim3(256, 1, 1), dim3(64, 1, 1), 0, 0>>>(Constant_110_0, Broadcast_387_0);
// Add_float_float_float_cuda_Add_388<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(Dot_386_0, Broadcast_387_0, Add_388_0);
// Tanh_float_float_cuda_Tanh_389<<<dim3(32, 1, 1), dim3(512, 1, 1), 0, 0>>>(Add_388_0, Tanh_389_0);
...
// Description:	Convert
// Input:
//	- name: Reshape_115_0	type: int32_t	shape: Shape{16, 1, 128}
// Output:
//	- name: Convert_120_0	type: float	shape: Shape{16, 1, 128}
...
//	- name: Reshape_124_0	type: float	shape: Shape{16, 128}
//	- name: Broadcast_127_0	type: float	shape: Shape{16, 128, 128}
...
// Output:
//	- name: Multiply_148_0	type: float	shape: Shape{16, 1, 128, 128}
//	- name: Multiply_145_0	type: float	shape: Shape{16, 1, 128, 128}
// Fused functions:
// Broadcast_float_float_cuda_Broadcast_135<<<dim3(4096, 1, 1), dim3(64, 1, 1), 0, 0>>>(Reshape_134_0, Broadcast_135_0);
// Broadcast_float_float_cuda_Broadcast_125<<<dim3(4096, 1, 1), dim3(64, 1, 1), 0, 0>>>(Reshape_124_0, Broadcast_125_0);
// Multiply_float_float_float_cuda_Multiply_128<<<dim3(512, 1, 1), dim3(512, 1, 1), 0, 0>>>(Broadcast_125_0, Broadcast_127_0, Multiply_128_0);
// Reshape_float_float_cuda_lib_Reshape_131(Multiply_128_0, Reshape_131_0);
// Subtract_float_float_float_cuda_Subtract_136<<<dim3(512, 1, 1), dim3(512, 1, 1), 0, 0>>>(Broadcast_135_0, Reshape_131_0, Subtract_136_0);
// Broadcast_float_float_cuda_Broadcast_144<<<dim3(4096, 1, 1), dim3(64, 1, 1), 0, 0>>>(Reshape_143_0, Broadcast_144_0);
// Multiply_float_float_float_cuda_Multiply_145<<<dim3(512, 1, 1), dim3(512, 1, 1), 0, 0>>>(Subtract_136_0, Broadcast_144_0, Multiply_145_0);
// Broadcast_float_float_cuda_Broadcast_138<<<dim3(4096, 1, 1), dim3(64, 1, 1), 0, 0>>>(Reshape_137_0, Broadcast_138_0);
// Subtract_float_float_float_cuda_Subtract_139<<<dim3(512, 1, 1), dim3(512, 1, 1), 0, 0>>>(Broadcast_138_0, Reshape_131_0, Subtract_139_0);
// Broadcast_float_float_cuda_Broadcast_147<<<dim3(4096, 1, 1), dim3(64, 1, 1), 0, 0>>>(Reshape_146_0, Broadcast_147_0);
// Multiply_float_float_float_cuda_Multiply_148<<<dim3(512, 1, 1), dim3(512, 1, 1), 0, 0>>>(Subtract_139_0, Broadcast_147_0, Multiply_148_0);
...
// Description:	Dot
// Input:
//	- name: Reshape_385_0	type: float	shape: Shape{16, 1024}
//	- name: Constant_109_0	type: float	shape: Shape{1024, 1024}
// Output:
//	- name: Dot_386_0	type: float	shape: Shape{16, 1024}
void Dot_float_float_float_cuda_lib_Dot_386(cublasHandle_t cublas_handle, float* input0, float* input1, float* output0)
{
    const float alpha = 1.0;
    const float beta = 0;
    CUBLAS_SAFE_CALL(cublasSgemm(cublas_handle, CUBLAS_OP_N, CUBLAS_OP_N, 1024, 16, 1024, &alpha, static_cast<const float*>(input1), 1024, static_cast<const float*>(input0), 1024, &beta, static_cast<float*>(output0), 1024));
...
//	- name: Add_197_0	type: float	shape: Shape{16, 16, 128, 128}
// Output:
//	- name: Softmax_198_0	type: float	shape: Shape{16, 16, 128, 128}
void Softmax_float_float_cuda_lib_Softmax_198(cudnnHandle_t cudnn_handle, float* input0, float* output0)
{
    cudnnTensorDescriptor_t input_tensor_desc;
    CUDNN_SAFE_CALL(cudnnCreateTensorDescriptor(&input_tensor_desc));
    CUDNN_SAFE_CALL(cudnnSetTensor4dDescriptor(input_tensor_desc, CUDNN_TENSOR_NCHW, CUDNN_DATA_FLOAT, 32768, 1, 1, 128));
    cudnnTensorDescriptor_t output_tensor_desc;
    CUDNN_SAFE_CALL(cudnnCreateTensorDescriptor(&output_tensor_desc));
    CUDNN_SAFE_CALL(cudnnSetTensor4dDescriptor(output_tensor_desc, CUDNN_TENSOR_NCHW, CUDNN_DATA_FLOAT, 32768, 1, 1, 128));
    const float alpha = 1.0;
    const float beta = 0.0;
    CUDNN_SAFE_CALL(cudnnSoftmaxForward(cudnn_handle, CUDNN_SOFTMAX_ACCURATE, CUDNN_SOFTMAX_MODE_INSTANCE, &alpha, input_tensor_desc, input0, &beta, output_tensor_desc, output0));
    CUDNN_SAFE_CALL(cudnnDestroyTensorDescriptor(input_tensor_desc));
...
void Dot_float_float_float_cuda_lib_Dot_122(cublasHandle_t cublas_handle, float* input0, float* input1, float* output0)
{
    const float alpha = 1.0;
    const float beta = 0;
    CUBLAS_SAFE_CALL(cublasSgemm(cublas_handle, CUBLAS_OP_N, CUBLAS_OP_N, 1024, 2048, 2, &alpha, static_cast<const float*>(input1), 1024, static_cast<const float*>(input0), 2, &beta, static_cast<float*>(output0), 1024));

}
// Node name:	 Elementwise Kernel Fusion
// Input:
//	- name: Sum_157_0	type: float	shape: Shape{16, 128}
//	- name: Constant_158_0	type: float	shape: Shape{16, 128}
//	- name: Reshape_161_0	type: float	shape: Shape{1}
// Output:
//	- name: Rsqrt_164_0	type: float	shape: Shape{16, 128, 1}
// Fused functions:
// Divide_float_float_float_cuda_Divide_159<<<dim3(4, 1, 1), dim3(512, 1, 1), 0, 0>>>(Sum_157_0, Constant_158_0, Divide_159_0);
// Reshape_float_float_cuda_lib_Reshape_160(Divide_159_0, Reshape_160_0);
// Broadcast_float_float_cuda_Broadcast_162<<<dim3(32, 1, 1), dim3(64, 1, 1), 0, 0>>>(Reshape_161_0, Broadcast_162_0);
// Add_float_float_float_cuda_Add_163<<<dim3(4, 1, 1), dim3(512, 1, 1), 0, 0>>>(Reshape_160_0, Broadcast_162_0, Add_163_0);
// Rsqrt_float_float_cuda_Rsqrt_164<<<dim3(4, 1, 1), dim3(512, 1, 1), 0, 0>>>(Add_163_0, Rsqrt_164_0);
...
// Description:	Reshape
// Input:
//	- name: Parameter_2_0	type: int32_t	shape: Shape{16, 128}
// Output:
//	- name: Reshape_114_0	type: int32_t	shape: Shape{2048}
void Reshape_int32_t_int32_t_cuda_lib_Reshape_114(cudaStream_t stream, int32_t* input0, int32_t* output0)
{
    if (input0 != output0) {
       cudaMemcpyAsync(output0, input0, 2048 * sizeof(int32_t), cudaMemcpyDeviceToDevice, stream);
    }
...
// Description:	Slice
// Input:
//	- name: Reshape_383_0	type: float	shape: Shape{16, 128, 1024}
// Output:
//	- name: Slice_384_0	type: float	shape: Shape{16, 1, 1024}
...
// Input:
// Output:
//	- name: Constant_365_0	type: float	shape: Shape{2048}
...
//	- name: Constant_59_0	type: float	shape: Shape{4096, 1024}
// Output:
//	- name: Dot_249_0	type: float	shape: Shape{2048, 1024}
void Dot_float_float_float_cuda_lib_Dot_249(cublasHandle_t cublas_handle, float* input0, float* input1, float* output0)
{
    const float alpha = 1.0;
    const float beta = 0;
    CUBLAS_SAFE_CALL(cublasSgemm(cublas_handle, CUBLAS_OP_N, CUBLAS_OP_N, 1024, 2048, 4096, &alpha, static_cast<const float*>(input1), 1024, static_cast<const float*>(input0), 4096, &beta, static_cast<float*>(output0), 1024));
...
//	- name: Reshape_191_0	type: float	shape: Shape{16, 16, 128, 64}
// Output:
//	- name: BatchMatMul_199_0	type: float	shape: Shape{16, 16, 128, 64}
...
//	- name: BatchMatMul_199_0	type: float	shape: Shape{16, 16, 128, 64}
// Output:
//	- name: Reshape_200_0	type: float	shape: Shape{16, 128, 16, 64}
...
// Output:
//	- name: Add_392_0	type: float	shape: Shape{16, 1001}
extern "C" __launch_bounds__(364) __global__ void Add_float_float_float_cuda_Add_392(float* input0, float* input1, float* output0)
{
    output0[blockIdx.x * 364 + threadIdx.x] = add(input0[blockIdx.x * 364 + threadIdx.x], input1[blockIdx.x * 364 + threadIdx.x]);
...
// Description:	Dot
// Input:
//	- name: Add_232_0	type: float	shape: Shape{2048, 1024}
//	- name: Constant_52_0	type: float	shape: Shape{1024, 4096}
// Output:
//	- name: Dot_233_0	type: float	shape: Shape{2048, 4096}
void Dot_float_float_float_cuda_lib_Dot_233(cublasHandle_t cublas_handle, float* input0, float* input1, float* output0)
{
    const float alpha = 1.0;
    const float beta = 0;
    CUBLAS_SAFE_CALL(cublasSgemm(cublas_handle, CUBLAS_OP_N, CUBLAS_OP_N, 4096, 2048, 1024, &alpha, static_cast<const float*>(input1), 4096, static_cast<const float*>(input0), 1024, &beta, static_cast<float*>(output0), 4096));
...
// total memory:323343680
CUDA_SAFE_CALL(cudaSetDevice(0));
CUDA_SAFE_CALL(cudaMalloc((void**)&group_0_CUDA_GPU0_allocator_memory_pool,87056384));
CUDA_SAFE_CALL(cudaMemset((void*)group_0_CUDA_GPU0_allocator_memory_pool, 0, 87056384));
Reshape_114_0 = (int32_t*)(group_0_CUDA_GPU0_allocator_memory_pool+0);
OneHot_118_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8192);
Dot_122_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+24576);
...
GatherV2_121_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8413184);
Add_142_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+16801792);
...
Multiply_156_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8192);
Sum_157_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8396800);
Rsqrt_164_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8192);
Reshape_165_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8192);
Add_175_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+16384);
Reshape_176_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+16384);
Dot_179_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8404992);
Add_185_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+16793600);
Reshape_188_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+16793600);
Reshape_191_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8404992);
Dot_178_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+16793600);
Add_183_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+25182208);
Reshape_187_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+25182208);
Reshape_190_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+16793600);
Dot_177_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+25182208);
Add_181_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+33570816);
Reshape_186_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+33570816);
Reshape_189_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+25182208);
BatchMatMul_192_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+33570816);
...
Reshape_115_0 = (int32_t*)(group_0_CUDA_GPU0_allocator_memory_pool+8192);
Convert_120_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+16793600);
Reshape_126_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+16793600);
Broadcast_127_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+16801792);
Multiply_145_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+17850368);
Multiply_148_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+18898944);
Reshape_195_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+17850368);
Broadcast_196_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+50348032);
Add_197_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+67125248);
Softmax_198_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+67125248);
BatchMatMul_199_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+19947520);
Reshape_200_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8404992);
Reshape_201_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8404992);
Dot_202_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+19947520);
Add_205_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8404992);
...
Multiply_213_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8192);
Sum_214_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8396800);
Rsqrt_221_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8192);
Reshape_222_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8192);
Add_232_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+16384);
Dot_233_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+19947520);
Multiply_248_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+53501952);
Dot_249_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8404992);
Add_252_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+19947520);
...
Multiply_260_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8192);
Sum_261_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8396800);
Rsqrt_268_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8192);
Reshape_269_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8192);
Add_279_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+16384);
Dot_282_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8404992);
Add_288_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+19947520);
Reshape_291_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+19947520);
Reshape_294_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8404992);
Dot_281_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+19947520);
Add_286_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+28336128);
Reshape_290_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+28336128);
Reshape_293_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+19947520);
Dot_280_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+28336128);
Add_284_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+36724736);
Reshape_289_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+36724736);
Reshape_292_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+28336128);
BatchMatMul_295_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+36724736);
Reshape_298_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+18898944);
Broadcast_299_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+19947520);
Add_300_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+53501952);
Softmax_301_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+53501952);
BatchMatMul_302_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+16793600);
Reshape_303_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8404992);
Reshape_304_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8404992);
Dot_305_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+16793600);
Add_308_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8404992);
...
Multiply_316_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8192);
Sum_317_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8396800);
Rsqrt_324_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8192);
Reshape_325_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8192);
Add_335_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+16384);
Dot_336_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8404992);
Multiply_351_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+41959424);
Dot_352_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8404992);
Add_355_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+16793600);
...
Multiply_363_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8192);
Sum_364_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8396800);
Rsqrt_371_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8192);
Reshape_372_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8192);
Add_382_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+16384);
Reshape_383_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+16384);
Slice_384_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8404992);
Reshape_385_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+8404992);
Dot_386_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+0);
Tanh_389_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+65536);
Dot_390_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+0);
Broadcast_391_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+64064);
Add_392_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+0);
Softmax_393_0 = (float*)(group_0_CUDA_GPU0_allocator_memory_pool+64064);
CUDA_SAFE_CALL(cudaSetDevice(0));
CUDA_SAFE_CALL(cudaMalloc((void**)&group_persist_CUDA_GPU0_allocator_memory_pool,236287296));
CUDA_SAFE_CALL(cudaMemset((void*)group_persist_CUDA_GPU0_allocator_memory_pool, 0, 236287296));
...
Constant_22_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+135540736);
Reshape_161_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+135540736);
Constant_158_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+135540800);
Constant_37_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+135548992);
Constant_30_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+135549056);
Constant_29_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+135553152);
Constant_28_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+139747456);
Constant_27_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+139751552);
Constant_79_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+143945856);
Reshape_146_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+143945856);
Constant_40_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+143945920);
Reshape_143_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+143945920);
Constant_78_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+143945984);
Reshape_137_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+143945984);
Constant_39_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+143946048);
Reshape_134_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+143946048);
Constant_25_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+143946112);
Constant_45_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+143946176);
Constant_48_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+148140480);
Constant_47_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+148144576);
Constant_207_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+148148672);
Constant_51_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+148156864);
Reshape_218_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+148156864);
Constant_215_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+148156928);
Constant_60_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+148165120);
Constant_58_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+148169216);
Constant_56_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+148169280);
Constant_55_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+148169344);
Constant_53_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+148169408);
Constant_57_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+148185792);
Constant_54_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+148185856);
Constant_52_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+148185920);
Constant_59_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+164963136);
Constant_62_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+181740352);
Constant_61_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+181744448);
Constant_254_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+181748544);
Constant_65_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+181756736);
Reshape_265_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+181756736);
Constant_262_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+181756800);
Constant_85_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+181764992);
Constant_71_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+181769088);
Constant_70_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+181773184);
Constant_76_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+185967488);
Constant_69_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+185967552);
Constant_68_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+185971648);
Constant_67_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+190165952);
Constant_66_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+190170048);
Constant_84_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+194364352);
Constant_87_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+198558656);
Constant_86_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+198562752);
Constant_310_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+198566848);
Constant_90_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+198575040);
Reshape_321_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+198575040);
Constant_318_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+198575104);
Constant_99_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+198583296);
Constant_97_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+198587392);
Constant_95_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+198587456);
Constant_94_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+198587520);
Constant_92_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+198587584);
Constant_96_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+198603968);
Constant_93_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+198604032);
Constant_91_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+198604096);
Constant_98_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+215381312);
Constant_101_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+232158528);
Constant_100_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+232162624);
Constant_357_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+232166720);
Constant_104_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+232174912);
Reshape_368_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+232174912);
Constant_365_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+232174976);
Constant_111_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+232183168);
Constant_112_0 = (float*)(group_persist_CUDA_GPU0_allocator_memory_pool+236283264);
...
OneHot_int32_t_float_cuda_OneHot_118_Call(dim3(32, 1, 1), dim3(64, 1, 1), 0, 0, Reshape_114_0, OneHot_118_0);
...
GatherV2_float_int32_t_float_cuda_GatherV2_121_Call(dim3(32768, 1, 1), dim3(64, 1, 1), 0, 0, Constant_4_0, Reshape_117_0, GatherV2_121_0);
...
FusedKernel_float_float_float_float_cuda_Reshape_Reshape_Add_Broadcast_Add_0_Call(dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0, GatherV2_121_0, Dot_122_0, Reshape_140_0, Add_142_0);
 // name=Sum_149
Sum_float_float_cuda_Sum_149_Call(dim3(2048, 1, 1), dim3(512, 1, 1), 0, 0, Add_142_0, Sum_149_0);
 // name=Divide_151
Divide_float_float_float_cuda_Divide_151_Call(dim3(4, 1, 1), dim3(512, 1, 1), 0, 0, Sum_149_0, Constant_150_0, Divide_151_0);
 // name=bert/embeddings/LayerNorm/moments/mean
// eliminated
 // name=Reshape_153
// eliminated
 // name=fused_kernel_397
FusedKernel_float_float_float_cuda_Broadcast_Subtract_Multiply_2_Call(dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0, Reshape_153_0, Add_142_0, Multiply_156_0);
 // name=Sum_157
Sum_float_float_cuda_Sum_149_Call(dim3(2048, 1, 1), dim3(512, 1, 1), 0, 0, Multiply_156_0, Sum_157_0);
 // name=Reshape_161
// eliminated
 // name=fused_kernel_398
FusedKernel_float_float_float_float_cuda_Divide_Reshape_Broadcast_Add_Rsqrt_3_Call(dim3(4, 1, 1), dim3(512, 1, 1), 0, 0, Sum_157_0, Constant_158_0, Reshape_161_0, Rsqrt_164_0);
 // name=Reshape_165
// eliminated
 // name=fused_kernel_399
FusedKernel_float_float_float_float_float_float_cuda_Broadcast_Broadcast_Broadcast_Broadcast_Multiply_Multiply_Subtract_Multiply_Add_4_Call(dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0, Constant_18_0, Reshape_153_0, Reshape_165_0, Constant_19_0, Add_142_0, Add_175_0);
...
FusedKernel_float_float_float_cuda_Broadcast_Add_7_Call(dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0, Constant_32_0, Dot_179_0, Add_185_0);
 // name=bert/encoder/layer_0/attention/self/Reshape_2
// eliminated
 // name=bert/encoder/layer_0/attention/self/transpose_2
Reshape_float_float_cuda_Reshape_191_Call(dim3(32768, 1, 1), dim3(64, 1, 1), 0, 0, Reshape_188_0, Reshape_191_0);
...
FusedKernel_float_float_float_cuda_Broadcast_Add_7_Call(dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0, Constant_30_0, Dot_178_0, Add_183_0);
 // name=bert/encoder/layer_0/attention/self/Reshape_1
// eliminated
 // name=bert/encoder/layer_0/attention/self/transpose_1
Reshape_float_float_cuda_Reshape_191_Call(dim3(32768, 1, 1), dim3(64, 1, 1), 0, 0, Reshape_187_0, Reshape_190_0);
...
FusedKernel_float_float_float_cuda_Broadcast_Add_7_Call(dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0, Constant_28_0, Dot_177_0, Add_181_0);
 // name=bert/encoder/layer_0/attention/self/Reshape
// eliminated
 // name=bert/encoder/layer_0/attention/self/transpose
Reshape_float_float_cuda_Reshape_191_Call(dim3(32768, 1, 1), dim3(64, 1, 1), 0, 0, Reshape_186_0, Reshape_189_0);
...
Broadcast_float_float_cuda_Broadcast_116_Call(dim3(32, 1, 1), dim3(64, 1, 1), 0, 0, Constant_25_0, Broadcast_116_0);
 // name=Reshape_124
// eliminated
...
Convert_int32_t_float_cuda_Convert_120_Call(dim3(4, 1, 1), dim3(512, 1, 1), 0, 0, Reshape_115_0, Convert_120_0);
 // name=Reshape_126
// eliminated
 // name=Broadcast_127
Broadcast_float_float_cuda_Broadcast_127_Call(dim3(4096, 1, 1), dim3(64, 1, 1), 0, 0, Reshape_126_0, Broadcast_127_0);
 // name=fused_kernel_396
FusedKernel_float_float_float_float_float_float_float_float_cuda_Broadcast_Broadcast_Multiply_Reshape_Subtract_Broadcast_Multiply_Broadcast_Subtract_Broadcast_Multiply_1_Call(dim3(512, 1, 1), dim3(512, 1, 1), 0, 0, Reshape_134_0, Reshape_124_0, Broadcast_127_0, Reshape_143_0, Reshape_137_0, Reshape_146_0, Multiply_148_0, Multiply_145_0);
 // name=Reshape_195
// eliminated
 // name=Broadcast_196
Broadcast_float_float_cuda_Broadcast_196_Call(dim3(65536, 1, 1), dim3(64, 1, 1), 0, 0, Reshape_195_0, Broadcast_196_0);
 // name=fused_kernel_403
FusedKernel_float_float_float_float_cuda_Broadcast_Multiply_Add_8_Call(dim3(8192, 1, 1), dim3(512, 1, 1), 0, 0, Constant_37_0, BatchMatMul_192_0, Broadcast_196_0, Add_197_0);
...
Reshape_float_float_cuda_Reshape_200_Call(dim3(32768, 1, 1), dim3(64, 1, 1), 0, 0, BatchMatMul_199_0, Reshape_200_0);
...
FusedKernel_float_float_float_float_cuda_Broadcast_Add_Add_9_Call(dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0, Constant_46_0, Dot_202_0, Reshape_176_0, Add_205_0);
 // name=Sum_206
Sum_float_float_cuda_Sum_149_Call(dim3(2048, 1, 1), dim3(512, 1, 1), 0, 0, Add_205_0, Sum_206_0);
 // name=Divide_208
Divide_float_float_float_cuda_Divide_151_Call(dim3(4, 1, 1), dim3(512, 1, 1), 0, 0, Sum_206_0, Constant_207_0, Divide_208_0);
 // name=bert/encoder/layer_0/attention/output/LayerNorm/moments/mean
// eliminated
 // name=Reshape_210
// eliminated
 // name=fused_kernel_405
FusedKernel_float_float_float_cuda_Broadcast_Subtract_Multiply_2_Call(dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0, Reshape_210_0, Add_205_0, Multiply_213_0);
 // name=Sum_214
Sum_float_float_cuda_Sum_149_Call(dim3(2048, 1, 1), dim3(512, 1, 1), 0, 0, Multiply_213_0, Sum_214_0);
 // name=Reshape_218
// eliminated
 // name=fused_kernel_406
FusedKernel_float_float_float_float_cuda_Divide_Reshape_Broadcast_Add_Rsqrt_3_Call(dim3(4, 1, 1), dim3(512, 1, 1), 0, 0, Sum_214_0, Constant_215_0, Reshape_218_0, Rsqrt_221_0);
 // name=Reshape_222
// eliminated
 // name=fused_kernel_407
FusedKernel_float_float_float_float_float_float_cuda_Broadcast_Broadcast_Broadcast_Broadcast_Multiply_Multiply_Subtract_Multiply_Add_4_Call(dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0, Constant_47_0, Reshape_210_0, Reshape_222_0, Constant_48_0, Add_205_0, Add_232_0);
...
FusedKernel_float_float_float_float_cuda_Broadcast_Add_Add_9_Call(dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0, Constant_60_0, Dot_249_0, Add_232_0, Add_252_0);
 // name=Sum_253
Sum_float_float_cuda_Sum_149_Call(dim3(2048, 1, 1), dim3(512, 1, 1), 0, 0, Add_252_0, Sum_253_0);
 // name=Divide_255
Divide_float_float_float_cuda_Divide_151_Call(dim3(4, 1, 1), dim3(512, 1, 1), 0, 0, Sum_253_0, Constant_254_0, Divide_255_0);
 // name=bert/encoder/layer_0/output/LayerNorm/moments/mean
// eliminated
 // name=Reshape_257
// eliminated
 // name=fused_kernel_410
FusedKernel_float_float_float_cuda_Broadcast_Subtract_Multiply_2_Call(dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0, Reshape_257_0, Add_252_0, Multiply_260_0);
 // name=Sum_261
Sum_float_float_cuda_Sum_149_Call(dim3(2048, 1, 1), dim3(512, 1, 1), 0, 0, Multiply_260_0, Sum_261_0);
 // name=Reshape_265
// eliminated
 // name=fused_kernel_411
FusedKernel_float_float_float_float_cuda_Divide_Reshape_Broadcast_Add_Rsqrt_3_Call(dim3(4, 1, 1), dim3(512, 1, 1), 0, 0, Sum_261_0, Constant_262_0, Reshape_265_0, Rsqrt_268_0);
 // name=Reshape_269
// eliminated
 // name=fused_kernel_412
FusedKernel_float_float_float_float_float_float_cuda_Broadcast_Broadcast_Broadcast_Broadcast_Multiply_Multiply_Subtract_Multiply_Add_4_Call(dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0, Constant_61_0, Reshape_257_0, Reshape_269_0, Constant_62_0, Add_252_0, Add_279_0);
...
FusedKernel_float_float_float_cuda_Broadcast_Add_7_Call(dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0, Constant_71_0, Dot_282_0, Add_288_0);
 // name=bert/encoder/layer_1/attention/self/Reshape_2
// eliminated
 // name=bert/encoder/layer_1/attention/self/transpose_2
Reshape_float_float_cuda_Reshape_191_Call(dim3(32768, 1, 1), dim3(64, 1, 1), 0, 0, Reshape_291_0, Reshape_294_0);
...
FusedKernel_float_float_float_cuda_Broadcast_Add_7_Call(dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0, Constant_69_0, Dot_281_0, Add_286_0);
 // name=bert/encoder/layer_1/attention/self/Reshape_1
// eliminated
 // name=bert/encoder/layer_1/attention/self/transpose_1
Reshape_float_float_cuda_Reshape_191_Call(dim3(32768, 1, 1), dim3(64, 1, 1), 0, 0, Reshape_290_0, Reshape_293_0);
...
FusedKernel_float_float_float_cuda_Broadcast_Add_7_Call(dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0, Constant_67_0, Dot_280_0, Add_284_0);
 // name=bert/encoder/layer_1/attention/self/Reshape
// eliminated
 // name=bert/encoder/layer_1/attention/self/transpose
Reshape_float_float_cuda_Reshape_191_Call(dim3(32768, 1, 1), dim3(64, 1, 1), 0, 0, Reshape_289_0, Reshape_292_0);
...
// eliminated
 // name=Broadcast_299
Broadcast_float_float_cuda_Broadcast_196_Call(dim3(65536, 1, 1), dim3(64, 1, 1), 0, 0, Reshape_298_0, Broadcast_299_0);
 // name=fused_kernel_416
FusedKernel_float_float_float_float_cuda_Broadcast_Multiply_Add_8_Call(dim3(8192, 1, 1), dim3(512, 1, 1), 0, 0, Constant_76_0, BatchMatMul_295_0, Broadcast_299_0, Add_300_0);
...
Reshape_float_float_cuda_Reshape_200_Call(dim3(32768, 1, 1), dim3(64, 1, 1), 0, 0, BatchMatMul_302_0, Reshape_303_0);
...
FusedKernel_float_float_float_float_cuda_Broadcast_Add_Add_9_Call(dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0, Constant_85_0, Dot_305_0, Add_279_0, Add_308_0);
 // name=Sum_309
Sum_float_float_cuda_Sum_149_Call(dim3(2048, 1, 1), dim3(512, 1, 1), 0, 0, Add_308_0, Sum_309_0);
 // name=Divide_311
Divide_float_float_float_cuda_Divide_151_Call(dim3(4, 1, 1), dim3(512, 1, 1), 0, 0, Sum_309_0, Constant_310_0, Divide_311_0);
 // name=bert/encoder/layer_1/attention/output/LayerNorm/moments/mean
// eliminated
 // name=Reshape_313
// eliminated
 // name=fused_kernel_418
FusedKernel_float_float_float_cuda_Broadcast_Subtract_Multiply_2_Call(dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0, Reshape_313_0, Add_308_0, Multiply_316_0);
 // name=Sum_317
Sum_float_float_cuda_Sum_149_Call(dim3(2048, 1, 1), dim3(512, 1, 1), 0, 0, Multiply_316_0, Sum_317_0);
 // name=Reshape_321
// eliminated
 // name=fused_kernel_419
FusedKernel_float_float_float_float_cuda_Divide_Reshape_Broadcast_Add_Rsqrt_3_Call(dim3(4, 1, 1), dim3(512, 1, 1), 0, 0, Sum_317_0, Constant_318_0, Reshape_321_0, Rsqrt_324_0);
 // name=Reshape_325
// eliminated
 // name=fused_kernel_420
FusedKernel_float_float_float_float_float_float_cuda_Broadcast_Broadcast_Broadcast_Broadcast_Multiply_Multiply_Subtract_Multiply_Add_4_Call(dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0, Constant_86_0, Reshape_313_0, Reshape_325_0, Constant_87_0, Add_308_0, Add_335_0);
...
FusedKernel_float_float_float_float_float_float_float_float_cuda_Broadcast_Broadcast_Broadcast_Broadcast_Broadcast_Add_Broadcast_Power_Multiply_Add_Multiply_Tanh_Add_Multiply_Multiply_13_Call(dim3(16384, 1, 1), dim3(512, 1, 1), 0, 0, Constant_97_0, Constant_96_0, Constant_95_0, Constant_94_0, Constant_92_0, Dot_336_0, Constant_93_0, Multiply_351_0);
...
FusedKernel_float_float_float_float_cuda_Broadcast_Add_Add_9_Call(dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0, Constant_99_0, Dot_352_0, Add_335_0, Add_355_0);
 // name=Sum_356
Sum_float_float_cuda_Sum_149_Call(dim3(2048, 1, 1), dim3(512, 1, 1), 0, 0, Add_355_0, Sum_356_0);
 // name=Divide_358
Divide_float_float_float_cuda_Divide_151_Call(dim3(4, 1, 1), dim3(512, 1, 1), 0, 0, Sum_356_0, Constant_357_0, Divide_358_0);
 // name=bert/encoder/layer_1/output/LayerNorm/moments/mean
// eliminated
 // name=Reshape_360
// eliminated
 // name=fused_kernel_423
FusedKernel_float_float_float_cuda_Broadcast_Subtract_Multiply_2_Call(dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0, Reshape_360_0, Add_355_0, Multiply_363_0);
 // name=Sum_364
Sum_float_float_cuda_Sum_149_Call(dim3(2048, 1, 1), dim3(512, 1, 1), 0, 0, Multiply_363_0, Sum_364_0);
 // name=Reshape_368
// eliminated
 // name=fused_kernel_424
FusedKernel_float_float_float_float_cuda_Divide_Reshape_Broadcast_Add_Rsqrt_3_Call(dim3(4, 1, 1), dim3(512, 1, 1), 0, 0, Sum_364_0, Constant_365_0, Reshape_368_0, Rsqrt_371_0);
 // name=Reshape_372
// eliminated
 // name=fused_kernel_425
FusedKernel_float_float_float_float_float_float_cuda_Broadcast_Broadcast_Broadcast_Broadcast_Multiply_Multiply_Subtract_Multiply_Add_4_Call(dim3(4096, 1, 1), dim3(512, 1, 1), 0, 0, Constant_100_0, Reshape_360_0, Reshape_372_0, Constant_101_0, Add_355_0, Add_382_0);
 // name=bert/encoder/Reshape_3
// eliminated
 // name=bert/pooler/strided_slice
Slice_float_float_cuda_Slice_384_Call(dim3(256, 1, 1), dim3(64, 1, 1), 0, 0, Reshape_383_0, Slice_384_0);
...
FusedKernel_float_float_float_cuda_Broadcast_Add_Tanh_31_Call(dim3(32, 1, 1), dim3(512, 1, 1), 0, 0, Constant_110_0, Dot_386_0, Tanh_389_0);
 // name=dense/MatMul
Dot_float_float_float_cuda_lib_Dot_390(cublas_handle_0, Tanh_389_0, Constant_111_0, Dot_390_0);
 // name=Broadcast_391
Broadcast_float_float_cuda_Broadcast_391_Call(dim3(251, 1, 1), dim3(64, 1, 1), 0, 0, Constant_112_0, Broadcast_391_0);
 // name=dense/BiasAdd
Add_float_float_float_cuda_Add_392_Call(dim3(44, 1, 1), dim3(364, 1, 1), 0, 0, Dot_390_0, Broadcast_391_0, Add_392_0);
 // name=dense/Softmax
