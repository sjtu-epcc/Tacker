...
__device__ void mrif_tzgemm_mrif0(int numK, int kGlobalIndex, float* x, float* y, float* z, float* outR, float* outI, 
...
// int
__device__ void mrif_tzgemm_mrif0_int(int numK, int kGlobalIndex, int* x, int* y, int* z, int* outR, int* outI, 
	    int grid_dimension_x, int grid_dimension_y, int grid_dimension_z, int block_dimension_x, int block_dimension_y, int block_dimension_z,  
		    int ptb_start_block_pos, int ptb_iter_block_step, int ptb_end_block_pos, int thread_base) {
...
#ifdef AKER_INT8
__device__ void mrif_tzgemm_tzgemm0(int8_t *A, int8_t *B, int16_t *C, 
#else
__device__ void mrif_tzgemm_tzgemm0(half *A, half *B, float *C, 
#endif
...
#ifdef AKER_INT8
__device__ void mrif_tzgemm_tzgemm1(int8_t *A, int8_t *B, int16_t *C, 
#else
__device__ void mrif_tzgemm_tzgemm1(half *A, half *B, float *C, 
#endif
		// float alpha, float beta,
		int M_GLOBAL, int N_GLOBAL, int K_GLOBAL,
		int grid_dimension_x, int grid_dimension_y, int grid_dimension_z, int block_dimension_x, int block_dimension_y, int block_dimension_z,  
...
__global__ void mrif_tzgemm_mix(int mrif0_numK, int mrif0_kGlobalIndex, float* mrif0_x, float* mrif0_y, float* mrif0_z, float* mrif0_outR, float* mrif0_outI, 
		int mrif0_grid_dimension_x, int mrif0_grid_dimension_y, int mrif0_grid_dimension_z, int mrif0_block_dimension_x, int mrif0_block_dimension_y, int mrif0_block_dimension_z, int mrif0_ptb_start_block_pos, int mrif0_ptb_iter_block_step, int mrif0_ptb_end_block_pos,
#ifdef AKER_INT8
...
// __global__ void mrif_tzgemm_mix_int(int mrif0_numK, int mrif0_kGlobalIndex, int* mrif0_x, int* mrif0_y, int* mrif0_z, int* mrif0_outR, int* mrif0_outI, 
// 		int mrif0_grid_dimension_x, int mrif0_grid_dimension_y, int mrif0_grid_dimension_z, int mrif0_block_dimension_x, int mrif0_block_dimension_y, int mrif0_block_dimension_z, int mrif0_ptb_start_block_pos, int mrif0_ptb_iter_block_step, int mrif0_ptb_end_block_pos,
// #ifdef AKER_INT8
// 		int8_t* tzgemm1_A, int8_t* tzgemm1_B, int16_t* tzgemm1_C,
// #else
